      ...
      <div className='person-down'>
        ...
        <div className='main-content1'>
          <div className='shoucang1'>
            <img src={require('../../assets/images/shoucang1.png')} alt='收藏1' />
            <div className='shoucang-content'>免费高清素材网站分享|九个宝藏网站</div>
            <div className='shoucang-footer'>
              <img src={require('../../assets/images/shoucangheadlike1.png')} alt='收藏头像1' />
          ...
          <div className='shoucang2'>
            <img src={require('../../assets/images/shoucang2.png')} alt='收藏2' />
            <div className='shoucang-content'>网站首页如何设计？这次帮你全部理清！</div>
            <div className='shoucang-footer'>
              <img src={require('../../assets/images/shoucangheadlike2.png')} alt='收藏头像2' />
          ...
          <div className='shoucang3'>
            <img src={require('../../assets/images/shoucang3.png')} alt='收藏3' />
            <div className='shoucang-content'>记住这些规范，不用脑也可以做设计了</div>
            <div className='shoucang-footer'>
              <img src={require('../../assets/images/shoucangheadlike3.png')} alt='收藏头像3' />
          ...
          <div className='shoucang4'>
            <img src={require('../../assets/images/shoucang4.png')} alt='收藏4' />
            <div className='shoucang-content'>太简单了！只需三步，轻松设计,快来学习</div>
            <div className='shoucang-footer'>
              <img src={require('../../assets/images/shoucangheadlike4.png')} alt='收藏头像4' />
